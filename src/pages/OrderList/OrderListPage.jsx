...
const OrderListPage = ({ PROXY }) => {
  ...
  useEffect(() => {
    axios
      .get(`${PROXY}/api/orders/in-progress`, {
        headers: {
  ...
  return (
    <>
      ...
      <div className="ShoppingCartPage_top" style={{ cursor: "pointer" }}>
        <div
          style={{
            ...
            flexDirection: "row",
            alignItems: "center",
            backgroundColor: tab === "progress" ? "" : "#f6f6f6",
          }}
          onClick={() => {
            setTab("progress");
          }}
        ...
        <div
          style={{
            ...
            flexDirection: "row",
            alignItems: "center",
            backgroundColor: tab === "complete" ? "" : "#f6f6f6",
          }}
          onClick={() => {
            setTab("complete");
          }}
      ...
      <div className="ReviewPage_container">
        <OrderList
          orderList={tab === "progress" ? orderList : completeOrderList}
        />
      </div>
    </>
  );
