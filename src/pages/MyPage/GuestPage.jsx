...
const GuestPage = ({userData}) => {
    ...
    return (
        <>
            ...
            <div style={{display: "flex", width: "100%"}}><p style={{margin: "70px 0 0 10px", fontSize:"5px", fontWeight: "200", color: "#838383"}}>NANUM 은 통신판매중개자이며, 통신판매의 당사자가 아닙니다. 상품, <br/>상세정보, 거래에 관한 의무와 책임은 판매자에게 있습니다.</p></div>
