    ...
    <div className="ProductSelectPopUp_container">
      <div className="ProductSelectPopUp_top">
        ...
        <div className="ProductSelectPopUp_top_content">
          ...
          <div className="Quantity_plus_bar" onClick={handlePlusClick}>
            +
          </div>
          <div className="Quantity_bar">{quantity}</div>
          <div className="Quantity_minus_bar" onClick={handleMinusClick}>
            -
          </div>
        </div>
      </div>
      <div className="ProductSelectPopUp_bottom">
        <div className="ProductSelectPopUp_bottom_inner">
          <div className="ProductSelectPopUp_bottom_coment">
            본 상품은 택배 배송입니다.
          </div>
          <img
          ...
          ></img>
          <div
            className="ProductSelectPopUp_bottom_purchase_buttom"
