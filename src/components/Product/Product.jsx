...
const Product = ({ list }) => {
  ...
  const formattedRating = getFormattedRating(
    list.ratingAvg === undefined ? list.rating : list.ratingAvg
  ); // 평점 변환
    ...
    <div className="Product_container">
      <div className="Product_content">
        <div className="Product_image">
          <img
            src={list.imgUrl}
            className="search_prod_container"
            alt="상품이미지"
          ></img>
        </div>
        <div className="search_list_detail">
          <div className="search_seller">{list.seller}</div>
          <div className="search_prod_name">{list.name}</div>
          <div className="search_prod_price">
