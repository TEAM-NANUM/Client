        ...
        <div className="PurchaseUserInfo_container">
            ...
            <div className="PurchaseUserInfo_content">
                ...
                <div className="address">
                    ...
                    {userInfo && <div className="PurchaseUserInfo">{userInfo.address.zip_code} {userInfo.address.default_address} {userInfo.address.detail_address}</div>}
                </div>

                <div className="name">
                    <div className="PurchaseUserInfo_type">주문자 명</div>
                    {userInfo && <div className="PurchaseUserInfo">{userInfo.user_name}</div>}
                </div>
                <div className="phone_num">
                    <div className="PurchaseUserInfo_type">전화번호</div>
                    {userInfo && <div className="PurchaseUserInfo">{userInfo.phone_number}</div>}
                </div>
            </div>
        </div>
    )
