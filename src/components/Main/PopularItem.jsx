    ...
    <>
      <div className="pop_header">
        <div className="pop_header_txt">
          <span className="pop_span">오늘의 장보기, 이런건 어때요?</span>
        </div>
      </div>
      <div className="pop_opt_container">
        <div
          className={`pop_opt_btn ${
            searchOpt === "popular" ? "pop_opt_selected" : ""
          }`}
          onClick={() => {
            setSearchOpt("popular");
          }}
        >
          인기순
        </div>
        <div
          className={`pop_opt_btn ${
            searchOpt === "rating" ? "pop_opt_selected" : ""
          }`}
          onClick={() => {
            setSearchOpt("rating");
          }}
            ...
            <div className="main_prod_container">
              ...
              <div className="pop_img_des">
                ...
                <span className="pop_title_span">
                  <div className="pop_title" style={{ marginBottom: "3px" }}>
                    {product.name}
                  </div>
                </span>
      ...
      <div
        ...
        onClick={() => {
          navigate(`/search?q=+&sort=${searchOpt}`);
        }}
      >
        더 많은 상품 보러가기
        <img
