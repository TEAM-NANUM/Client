...
const ReviewAddList = ({ index, item, writtenReview }) => {
  ...
  const handlePost = () => {
    if (star !== 0 && inputValue !== "") {
      ...
      axios
        .post(`https://api.hanche.store/api/reviews`, requestData, {
          headers: {
          ...
          >
            <div>
              <img
                ...
                src={`./img/imgs/star${star >= 1 ? "On" : "Disable"}.svg`}
                onClick={() => {
                  setStar(1);
                }}
                alt="평점"
              ...
              <img
                ...
                src={`./img/imgs/star${star >= 2 ? "On" : "Disable"}.svg`}
                onClick={() => {
                  setStar(2);
                }}
                alt="평점"
              ...
              <img
                ...
                src={`./img/imgs/star${star >= 3 ? "On" : "Disable"}.svg`}
                onClick={() => {
                  setStar(3);
                }}
                alt="평점"
              ...
              <img
                ...
                src={`./img/imgs/star${star >= 4 ? "On" : "Disable"}.svg`}
                onClick={() => {
                  setStar(4);
                }}
                alt="평점"
              ...
              <img
                ...
                src={`./img/imgs/star${star >= 5 ? "On" : "Disable"}.svg`}
                onClick={() => {
                  setStar(5);
                }}
                alt="평점"
