  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ margin: "15px 0 auto 0 ", width: "170px", cursor: "default" }}
      >
        <div
          className="Product_name"
          style={{ marginLeft: "5px", fontWeight: "500", cursor: "default" }}
        >
          {orderItem.name}
        </div>
        <div
      ...
      >
        <div
          className={
            orderItem.delivery_status === "DELIVERED"
              ? "OrderItem_status_green"
              : orderItem.delivery_status === "PAYMENT_COMPLETE"
              ? "OrderItem_status_black"
        ...
        >
          {orderItem.delivery_status === "DELIVERED"
            ...
            : orderItem.delivery_status === "PAYMENT_COMPLETE"
            ? "결제 완료"
            : orderItem.delivery_status === "IN_PROGRESS"
            ? "배송 중"
