...
const SellerJoinForm = ({ PROXY }) => {
  ...
  const onSellerJoin = () => {
    if (password === confirm_password) {
      axios
        .post(`${PROXY}/api/signup/seller`, sellerJoinForm)
    ...
    <div className="SellerJoinForm_container">
      ...
      <div className="SellerJoinForm_phone_number">
        ...
        <input
          ...
          value={phone_number}
          type="text"
          placeholder="전화번호를 입력해주세요. (010-0000-0000 형식)"
          onChange={onPhone_Number}
        />
      </div>
      ...
      <div className="SellerJoinForm_joinBtn" onClick={onSellerJoin}>
        회원가입 하기
      </div>
    </div>
  );
