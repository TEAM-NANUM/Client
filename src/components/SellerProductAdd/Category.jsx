...
const Category = ({productForm, setProductForm,  category, setCategory}) => {
    ...
    const OPTIONS = [
        ...
        { value: 13, name: "선물세트" },
        { value: 14, name: "밤/견과류" },
        { value: 15, name: "쌈채소/오이/고추" },
        { value: 16, name: "무/열무/얼갈이" },
        { value: 17, name: "쌀/잡곡" },
        { value: 18, name: "뿌리채소/인삼" },
        { value: 19, name: "감자/고구마/옥수수" },
        { value: 20, name: "마늘/양파/파" },
        { value: 21, name: "나물/버섯/두부" },
        { value: 22, name: "기타농산물" },
        { value: 23, name: "선물세트" },
        { value: 24, name: "소고기" },
        { value: 25, name: "돼지고기" },
        { value: 26, name: "유제품" },
        { value: 27, name: "닭/오리/양" },
        { value: 28, name: "선물세트" },
        { value: 29, name: "배추김치" },
        { value: 30, name: "무김치" },
        { value: 31, name: "열무김치" },
        { value: 32, name: "갓김치" },
        { value: 33, name: "파/대파김치" },
        { value: 34, name: "물김치/동치미" },
        { value: 35, name: "별미김치" },
    ];
