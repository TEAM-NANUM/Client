  ...
  return (
    <div className="PointMethod_container">
      ...
      <div className="PointMethod_method" style={{ marginBottom: "40px" }}>
        <div
          className={paymentMethod === "kakaopay" ? "method_active" : "method"}
        ...
        >
          <img
            ...
            src="./img/imgPoint/kakaoPay.png"
            alt="카카오페이"
          ></img>
        </div>
        <div
          className={paymentMethod === "tosspay" ? "method_active" : "method"}
        ...
        >
          <img
            ...
            src="./img/imgPoint/tossPay.png"
            alt="토스페이"
          />
        </div>
        <div
          className={paymentMethod === "nice" ? "method_active" : "method"}
          onClick={() => setPaymentMethod("nice")}
        >
          <img
            style={{
              margin: "auto",
      ...
      >
        ...
        >
          {(point + userData.point).toLocaleString()}원
        </p>
      </div>
      <div
        style={{
