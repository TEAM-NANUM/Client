...
const ShoppingCartList = ({
  ...
  const handleUpdate = useCallback(
    async (count) => {
      if (shoppingCart.quantity + count <= 0) {
        return;
      }
      ...
      axios
        ...
        .then((res) => setShoppingCart(res.data.items))
    ...
    <div className="ShoppingCartList_content">
      <div className="opt_btn_wrapper">
        <img
          ...
          src={`./img/imgs/cartSelect${isSelected ? "On" : "Off"}Icon.svg`}
      ...
      <img
        ...
        src={shoppingCart.imgUrl}
        alt="상품이미지"
        onClick={() => {
          navigate(`/productDetail/${shoppingCart.productId}`);
        }}
      ></img>
      <div className="Product_detail_info">
        ...
        <div className="Product_price">
          {shoppingCart.totalPrice.toLocaleString()}원
        </div>
      ...
      <div
        className="opt_btn_wrapper"
        style={{ marginTop: "10px", marginLeft: "auto", marginRight: "12px" }}
