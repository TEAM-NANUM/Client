    ...
    <div className="MyInfo_container">
      ...
      <div className="MyInfo_content">
        <img
          ...
          src="./img/imgMyPage/profilHost.svg"
          alt="프로필 사진"
        />
        <div style={{ marginLeft: "4px" }}>
          <div className="account_title">일반 회원</div>
          <div
            style={{ margin: "0 0 3px 0", fontWeight: "500", fontSize: "22px" }}
          >
            {group.username}
          </div>
          <div className="MyInfo_money">
            <div>잔액</div>
            {group.point !== undefined && (
              <div className="money">{group.point.toLocaleString()}</div>
            )}
            <div>원</div>
          </div>
        </div>
